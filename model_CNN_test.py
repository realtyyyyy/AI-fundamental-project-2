...
#opencv自带的一个面部识别分类器
detection_model_path = 'E:\\artificial-intelligence-main\model\haarcascade_frontalface_default.xml'

classification_model_path = 'E:\\artificial-intelligence-main\model\model_cnn.pkl'
